...
class Admin
{
    ...
    public function __construct()
    {
        ...
        $controllerName = ($controllerName)? strtolower($controllerName) :  Config::get('admin_default_controller');
        $actionName     = ($actionName)?       strtolower($actionName)     :   Config::get('admin_default_action');
